...
const letterLabels = [
  ...
  'D',
  'E'
].map(c => colors.bold.yellow(c));

const topRow = colors.yellow('╔═══╤═══╤═══╤═══╤═══╤═══╤═══╤═══╤═══╤═══╤═══╤═══╤═══╤═══╤═══╤═══╗');
const sepRow = colors.yellow('╟───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───╢');
const botRow = colors.yellow('╚═══╧═══╧═══╧═══╧═══╧═══╧═══╧═══╧═══╧═══╧═══╧═══╧═══╧═══╧═══╧═══╝');
...
function printBoard(b) {
  console.log(topRow);
  console.log(colors.yellow('║ ') + letterLabels.join(colors.yellow(' │ ')) + colors.yellow(' ║'));
  console.log(sepRow);
