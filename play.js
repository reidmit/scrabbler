...
var Game = function(board, player1, player2) {
    ...
    self.tileBag = {
        ...
        s: 4, t: 6, u: 4, v: 2, w: 2,  x: 1, y: 4, z: 1
    };
    ...
    self.makeMove = function() {
        ...
        var possibleMoves = solver.solve(
            self.board,
            player.rack.join(""),
            player.strategy);
    ...
    self.endGame = function() {
        ...
        console.log(winMessage+" Final score: "+self.players[0].name+": "+self.players[0].score+" | "+self.players[1].name+": "+self.players[1].score)
